            ...
            <div class="lg:w-4/12 w-full lg:my-0 my-12 lg:order-1 order-3">
               <div class="flex justify-between mb-12">
                  ...
                  <ul class="lg:w-1/2 w-5/12">
                     ...
                     <li class="my-2"><a class="flex text-gray-900 dark:text-gray-100 hover:text-gray-600 dark:hover:text-gray-300 hover:tracking-wide transition-all duration-300" href="#" target="_blank">
